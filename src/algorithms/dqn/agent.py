"""
DQN Agent - Deep Q-Learning agent implementing AgentInterface.
"""
...
class DQNAgent(AgentInterface):
    ...
    def select_action(self, state: np.ndarray, training: bool = True) -> int:
        ...
        """
        if training and self._training_mode and random.random() < self.epsilon:
    ...
    def select_actions_batch(self, states: np.ndarray, training: bool = True) -> np.ndarray:
        ...
        Args:
            states: Batch of states, shape (N, state_size)
            training: If True, use exploration; if False, use greedy policy
