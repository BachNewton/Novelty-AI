"""
Snake Game Core - Pure game logic implementing GameInterface.
...
class SnakeGame(GameInterface):
    """
    Core Snake game logic implementing GameInterface.
    ...
    def get_metadata(cls) -> GameMetadata:
        """Return metadata about Snake game."""
        return GameMetadata(
            name="Snake",
            id="snake",
    ...
    def action_space_size(self) -> int:
        """Number of possible actions (straight, right, left)."""
        return 3

    @property
    def action_names(self) -> List[str]:
        """Human-readable action names."""
        return ["Straight", "Turn Right", "Turn Left"]
    ...
    def is_valid_action(self, action: int) -> bool:
        ...
        Args:
            action: Action to check (0, 1, or 2)
